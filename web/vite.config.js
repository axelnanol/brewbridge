...
export default defineConfig({
  ...
  build: {
    outDir: 'dist',
    // Dual target for maximum Tizen compatibility:
    //   'es2015'  → esbuild lowers async/await → generators (Chrome 39+), making
    //               the bundle parse-safe on Chrome 47-54 (pre-2016 Tizen TVs).
    ...
    // const/let and destructuring (Chrome 49+) are not transformed because esbuild
    // does not implement those lowerings; Chrome 47-48 tolerate them at runtime.
